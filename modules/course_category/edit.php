...
$data = ['title' => 'Chỉnh sửa lĩnh vực'];

$filter = filterData('get');
if (!empty($filter['id'])) {
    $cate_id = $filter['id'];
    $checkCate = getOne("SELECT * FROM course_category WHERE id=$cate_id");
...
<form action="" method="post">
    ...
    <div class="form-group">
        ...
        <input id="name" name="name" type="text" class="form-control" value="<?php if (!empty($oldData)) {
    ...
    <div class="form-group">
        ...
        <input id="slug" name="slug" type="text" class="form-control" value="<?php if (!empty($oldData)) {
